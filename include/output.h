...
static constexpr const char* kAvatar   = "avatar_bag.json";
...
static constexpr const char* kArtInitSubStats  = "      \"initSubStats\": %d,\n";
...
static constexpr const char* kAvatarHeader = "{\n  \"avatars\": [\n";
static constexpr const char* kAvatarItem   =
    "    {\"id\":%u,\"guid\":\"%llu\",\"level\":%u,\"promote\":%u,\"fetter\":%u,"
    "\"talents\":%s,\"skills\":%s,\"extras\":%s,\"equips\":%s}%s\n";
